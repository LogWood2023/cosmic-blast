...
const EnemyBulletScene = preload("res://scenes/entities/projectiles/EnemyBullet.tscn")
...
func _create_ring_drawer() -> void:
	...
	ring_drawer.set_script(preload("res://scripts/fx/RingDrawer.gd"))
...
func _build_cannons() -> void:
	...
	for i in CANNON_COUNT:
		var c = Area2D.new()
		c.set_script(preload("res://scripts/entities/bosses/ParadiseCannon.gd"))
		c.name = "Cannon%d" % (i + 1)
		var s = Sprite2D.new()
...
func _spawn_skill3_enemies(avoid_dock: int) -> void:
	var enemy_scenes = [
		"res://scenes/entities/enemies/EnemyShooter.tscn",
		"res://scenes/entities/enemies/EnemyScatter.tscn",
		"res://scenes/entities/enemies/EnemyChain.tscn",
		"res://scenes/entities/enemies/EnemyHealer.tscn",
	]
	var dirs: Array[int] = []
