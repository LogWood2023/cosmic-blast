...
# 技能3 — 敌机
const ENEMY_SCENES = [
	preload("res://scenes/entities/enemies/EnemyRammer.tscn"),
	preload("res://scenes/entities/enemies/EnemyThrower.tscn"),
	preload("res://scenes/entities/enemies/EnemySuicide.tscn"),
]
