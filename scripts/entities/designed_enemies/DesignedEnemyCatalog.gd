...
const ENEMIES: Array[Dictionary] = [
	...
	{"id":"ParadiseRailChain","name":"圣轨连射机","family":"天堂号","behavior":7,"hp":34,"damage":6,"size":Vector2(68,116),"color":Color(0.86,0.83,0.72,1),"accent":Color(0.5,0.9,1,1),"pos":Vector2(960,170),"mechanic":"偏好尾随航道，捕捉无遮挡瞬间打出连续圣轨。它的节奏稳定，适合在混战中补上致命火线。"},
