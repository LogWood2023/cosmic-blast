...
const ENEMY_BULLET_SCENE = preload("res://scenes/entities/projectiles/EnemyBullet.tscn")
const SKILL3_ENEMY_SCENES: Array[String] = [
	...
	"res://scenes/entities/enemies/EnemyRammer.tscn",
]
...
const WING_GLOW_SHADER = preload("res://assets/shaders/wing_glow.gdshader")
