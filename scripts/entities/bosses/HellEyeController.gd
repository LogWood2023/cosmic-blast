...
const MiniHellEyeScript = preload("res://scripts/entities/bosses/MiniHellEye.gd")
...
func _setup_body() -> void:
	...
	var clip_shader = preload("res://assets/shaders/helleye/eye_clip.gdshader")
...
func _skill_3() -> void:
	...
	for _i in bombers_assigned:
		enemy_types.append("res://scenes/entities/enemies/EnemyBomber.tscn")
	while enemy_types.size() < enemy_count:
		var t = "res://scenes/entities/enemies/EnemyRammer.tscn" if randf() < 0.5 else "res://scenes/entities/enemies/EnemyScatter.tscn"
...
func _skill_4_ensure_overlay() -> void:
	...
	var distort_shader = load("res://assets/shaders/helleye/screen_distort.gdshader")
	if distort_shader:
