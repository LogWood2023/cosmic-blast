...
func _spawn_aimed_bullet() -> void:
	var bullet = preload("res://scenes/entities/projectiles/EnemyBullet.tscn").instantiate()
...
func _spawn_single_quake_enemy() -> void:
	var idx = randi() % 2
	var path = "res://scenes/entities/enemies/EnemyMissile.tscn" if idx == 0 else "res://scenes/entities/enemies/EnemyRammer.tscn"
